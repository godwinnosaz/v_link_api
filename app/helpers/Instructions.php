...
trait Instructions
{
     ...
     */
    public static function createInstruction(
     ...
     * @throws InputValidationException
     */
    public static function updateInstruction(
        PublicKey $nameProgramId,
     ...
     * @throws InputValidationException
     */
    public static function transferInstruction(
        PublicKey $nameProgramId,
        PublicKey $nameAccountKey,
     ...
     * @throws InputValidationException
     */
    public static function reallocInstruction(
        PublicKey $nameProgramId,
        PublicKey $systemProgramId,
        PublicKey $payerKey,
        PublicKey $nameAccountKey,
     ...
     * @throws InputValidationException
     */
    public static function deleteInstruction(
        PublicKey $nameProgramId,
        PublicKey $nameAccountKey,
