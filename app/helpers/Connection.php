...
class Connection extends Program
{
     ...
     * @return array
     * @throws GenericException|MethodNotFoundException|InvalidIdResponseException
     ...
     * @return array
     * @throws GenericException|MethodNotFoundException|InvalidIdResponseException|ClientExceptionInterface
     */
